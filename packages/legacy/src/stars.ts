...
const IGNORED_WORLDS = [
  // f2p
  301, 308, 316, 326, 335, 372, 379, 380, 381, 382, 383, 384, 393, 398, 413,
  414, 417, 418, 419, 427, 430, 432, 434, 443, 451, 452, 453, 454, 455, 456,
  468, 469, 483, 497, 498, 499, 530, 537, 552, 553, 554, 555, 571, 590, 622,
  628, 648, 691,
  // 2k total
...
function isGridMasterWorld(w: number) {
  ...
  return r(431) || r(433) || r(435, 437) || r(622, 623) || w >= 628;
}
